...
2. Clone https://github.com/georgeepta/artemis-ansible repository in ../artemis/backend/ directory 
...
9. In ../artemis/backend/artemis-ansible/automation_tools/configs/ansible/hosts you must define the directly connected 
